...
**Not the runnable app** — Watsonx / Slate cells preserved for comparison.  
Runnable app: `app.py` (Groq/Ollama + local MiniLM).
...
def watsonx_embedding():
    embed_params = {
        EmbedTextParamsMetaNames.TRUNCATE_INPUT_TOKENS: 3,  # lab typo — do not copy
